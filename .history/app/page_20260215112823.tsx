  ...
  return (
    ...
    >
      ...
      <div className="flex-1 px-1 py-0.5 border-b border-black flex items-center bg-white overflow-hidden">
        <span className="text-[10px] text-black font-bold text-left w-full whitespace-normal break-words leading-tight pl-1">{course.subjectLabel || course.subject}</span>
      </div>

      {/* Troisième ligne du tableau : Enseignant */}
      <div className="min-h-[1.75rem] px-1 py-0.5 flex items-center bg-white overflow-hidden">
        <span className="text-[10px] font-bold text-red-600 text-left w-full whitespace-normal break-words leading-tight pl-1">{(() => {
