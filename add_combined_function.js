...
// Trouver la ligne avec schedule et ajouter la fonction après
const schedulePattern = /const \[schedule, setSchedule\] = useState<Record<string, string \| null \| string\[\]>>\(\{\}\);/;
const match = content.match(schedulePattern);
...
if (match) {
    ...
    console.log('✅ Fonction getCombinedCourseInfo ajoutée après la déclaration de schedule');
} else {
    console.log('❌ Déclaration de schedule non trouvée');
}
